...
EXCLUDE_DIRS = set(
    filter(
        None,
        [d.strip() for d in os.getenv("EXCLUDE_DIRS", ".git,node_modules,.venv,dist,build,__pycache__,.next,.turbo,.cache,.graphify,data,vendor,storage,lib_autogenerated").split(",")]
    )
)
